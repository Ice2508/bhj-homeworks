...
class Game {
    ...
    timerStart() {
        ...
        this.timeRemaining = this.currentWord;
        let timerSpan = this.container.querySelector('.timer');
        timerSpan.textContent = this.timeRemaining;
